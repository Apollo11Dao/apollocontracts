...
contract StakedApollo is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Apollo", "MOON", 9) ERC20Permit() {
    ...
    /**
        @notice increases MOON supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess MOON
